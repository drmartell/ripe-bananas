const { getActor, getActors, request, app, adminAgent } = require('../../helpers/data-helpers');
...
describe('actor routes', () => {
  ...
  it.skip('can get a list of all actors via GET', async() => {
  ...
  it.skip('can get a actor by id via GET', async() => {
    const actor = await getActor();
